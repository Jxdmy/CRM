...
public class IndexController extends BaseController {
	...
	public String search(Model model, @PathVariable String name) {
		try {
			...
			//
			// // 查询潜在客户数据
			// List<ProspectiveModel> prospectiveList =
			// prospectiveService.getProspectiveList(value);
			...
			// purchaseOrderService.getPurchaseOrderList(value);
